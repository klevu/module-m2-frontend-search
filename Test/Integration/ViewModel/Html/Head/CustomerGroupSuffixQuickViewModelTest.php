...
use Klevu\FrontendSearch\ViewModel\Html\Head\CustomerGroupSuffixQuick as CustomerGroupSuffixVirtualType;
 ...
 */
class CustomerGroupSuffixQuickViewModelTest extends TestCase
{
    ...
    public function testIsEnabled_ReturnTrue_WhenStoreIntegrated_QuickEnabled_CustomGroupPriceEnabledOnFrontend(): void
    {
        $this->createStore();
        $storeFixture = $this->storeFixturesPool->get('test_store');
        $scopeProvider = $this->objectManager->get(ScopeProviderInterface::class);
